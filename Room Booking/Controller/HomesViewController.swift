...
class HomesViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
...
class FreelancerCell: UICollectionViewCell {
    ...
    func addViews(){
        ...
        distanceLabel.widthAnchor.constraint(equalToConstant: 300).isActive = true
